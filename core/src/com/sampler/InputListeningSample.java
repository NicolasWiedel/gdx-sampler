...
public class InputListeningSample implements ApplicationListener, InputProcessor {
	...
	public boolean touchDown(int screenX, int screenY, int pointer, int button) {
		String message = "touchedDown screenX = " + screenX + " screenX = " + screenY;
		log.debug(message);
		addMessage(message);
		return true;
	}
	...
	public boolean touchUp(int screenX, int screenY, int pointer, int button) {
		String message = "touchedUp screenX = " + screenX + " screenX = " + screenY;
		log.debug(message);
		addMessage(message);
		return true;
	}
	...
	public boolean touchDragged(int screenX, int screenY, int pointer) {
		String message = "touchedDragged screenX = " + screenX + " screenX = " + screenY;
		log.debug(message);
		addMessage(message);
		return true;
	}
	...
	public boolean mouseMoved(int screenX, int screenY) {
		String message = "movedMouse = " + screenX + " screenX = " + screenY;
		log.debug(message);
		addMessage(message);
		return true;
	}
	...
	public boolean scrolled(int amount) {
		String message = "scrolled = " + amount;
		log.debug(message);
		addMessage(message);
		return true;
	}
